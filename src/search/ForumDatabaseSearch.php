...
class ForumDatabaseSearch implements ForumSearchProvider
{
     ...
     * @param int    $limit
     *
     * @return DataList Results of matching posts or empty DataSet if no results.
     */
    public function getResults($forumHolderID, $query, $order = null, $offset = 0, $limit = 10)
    {
        ...
        //We are aiming to keep this as simple as possible). More complex implementations achieved with Solr.
        //Requires the post be moderated, then Checks for any match of Author name or Content partial match.
